...
#define ACC(str) \
    do { \
        ...
        case L'ḇ':                 SEQ("{\\b b}");
        case L'Ḉ':
        case L'ḉ':                 return TEX_UNSUPPORTED;
        case L'Ḋ':                 SEQ("{\\.D}");
        case L'ḋ':                 SEQ("{\\.d}");
        case L'Ḍ':                 SEQ("{\\d D}");
        case L'ḍ':                 SEQ("{\\d d}");
        ...
        case L'Ḑ':                 SEQ("{\\c D}");
        case L'ḑ':                 SEQ("{\\c d}");
        case L'Ḓ' ... L'ḝ':        return TEX_UNSUPPORTED;
        case L'Ḟ':                 SEQ("{\\.F}");
        case L'ḟ':                 SEQ("{\\.f}");
        case L'Ḡ':                 SEQ("{\\=G}");
        case L'ḡ':                 SEQ("{\\=g}");
        ...
        case L'Ḩ':                 SEQ("{\\c H}");
        case L'ḩ':                 SEQ("{\\c h}");
        case L'Ḫ' ... L'ḯ':        return TEX_UNSUPPORTED;
        case L'Ḱ':                 SEQ("{\\'K}");
        case L'ḱ':                 SEQ("{\\'k}");
        case L'Ḳ':                 SEQ("{\\d K}");
        case L'ḳ':                 SEQ("{\\d k}");
        ...
        case L'ḷ':                 SEQ("{\\d l}");
        case L'Ḹ':
        case L'ḹ':                 return TEX_UNSUPPORTED;
        case L'Ḻ':                 SEQ("{\\b L}");
        case L'ḻ':                 SEQ("{\\b l}");
        case L'Ḽ':
        case L'ḽ':                 return TEX_UNSUPPORTED;
        case L'Ḿ':                 SEQ("{\\'M}");
        case L'ḿ':                 SEQ("{\\'m}");
        case L'Ṁ':                 SEQ("{\\.M}");
        case L'ṁ':                 SEQ("{\\.m}");
        ...
        case L'Ṉ':                 SEQ("{\\b N}");
        case L'ṉ':                 SEQ("{\\b n}");
        case L'Ṋ' ... L'ṓ':        return TEX_UNSUPPORTED;
        case L'Ṕ':                 SEQ("{\\'P}");
        case L'ṕ':                 SEQ("{\\'p}");
        case L'Ṗ':                 SEQ("{\\.P}");
        case L'ṗ':                 SEQ("{\\.p}");
        ...
        case L'ṛ':                 SEQ("{\\d r}");
        case L'Ṝ':
        case L'ṝ':                 return TEX_UNSUPPORTED;
        case L'Ṟ':                 SEQ("{\\b R}");
        case L'ṟ':                 SEQ("{\\b r}");
        case L'Ṡ':                 SEQ("{\\.S}");
        case L'ṡ':                 SEQ("{\\.s}");
        case L'Ṣ':                 SEQ("{\\d S}");
        case L'ṣ':                 SEQ("{\\d s}");
        case L'Ṥ' ... L'ṩ':        return TEX_UNSUPPORTED;
        case L'Ṫ':                 SEQ("{\\.T}");
        case L'ṫ':                 SEQ("{\\.t}");
        case L'Ṭ':                 SEQ("{\\d T}");
        case L'ṭ':                 SEQ("{\\d t}");
        case L'Ṯ':                 SEQ("{\\b T}");
        case L'ṯ':                 SEQ("{\\b t}");
        case L'Ṱ' ... L'ṻ':        return TEX_UNSUPPORTED;
        case L'Ṽ':                 SEQ("{\\~V}");
        case L'ṽ':                 SEQ("{\\~v}");
        case L'Ṿ':                 SEQ("{\\d V}");
        case L'ṿ':                 SEQ("{\\d v}");
        ...
        case L'ẘ':                 SEQ("{\\r w}");
        case L'ẙ':                 SEQ("{\\r y}");
        case L'ẚ' ... L'ẞ':        return TEX_UNSUPPORTED;
        case L'ẟ':                 SEQ("$\\delta$");
        case L'Ạ':                 SEQ("{\\d A}");
        case L'ạ':                 SEQ("{\\d a}");
        case L'Ả' ... L'ặ':        return TEX_UNSUPPORTED;
        case L'Ẹ':                 SEQ("{\\d E}");
        case L'ẹ':                 SEQ("{\\d e}");
        case L'Ẻ':
        case L'ẻ':                 return TEX_UNSUPPORTED;
        case L'Ẽ':                 SEQ("{\\~E}");
        case L'ẽ':                 SEQ("{\\~e}");
        case L'Ế' ... L'ỉ':        return TEX_UNSUPPORTED;
        case L'Ị':                 SEQ("{\\d I}");
        case L'ị':                 SEQ("{\\d i}");
        case L'Ọ':                 SEQ("{\\d O}");
        case L'ọ':                 SEQ("{\\d o}");
        case L'Ỏ' ... L'ợ':        return TEX_UNSUPPORTED;
        case L'Ụ':                 SEQ("{\\d U}");
        case L'ụ':                 SEQ("{\\d u}");
        case L'Ủ' ... L'ự':        return TEX_UNSUPPORTED;
        case L'Ỳ':                 SEQ("{\\`Y}");
        case L'ỳ':                 SEQ("{\\`y}");
        case L'Ỵ':                 SEQ("{\\d Y}");
        case L'ỵ':                 SEQ("{\\d y}");
        case L'Ỷ' ... L'ỷ':        return TEX_UNSUPPORTED;
        case L'Ỹ':                 SEQ("{\\~Y}");
        case L'ỹ':                 SEQ("{\\~y}");
        case L'Ỻ':                 SEQ("IL");
        ...
        case L'ₔ':                 return TEX_UNSUPPORTED;
        ...
        case 0x20bf ... 0x20cf:    return TEX_INVALID;
        ...
        case 0x218c ... 0x218f:    return TEX_INVALID;
